  ...
  const projects = [
    {
      ...
      github: 'https://github.com/Saurabh-e/Resume-Analyzer',
      live: 'https://resume-analyzer-fojo.vercel.app/',
    ...
    },
    {
      ...
      tagColors: ['bg-primary/30 border-primary/50', 'bg-secondary/30 border-secondary/50'],
      github: 'https://github.com/Sakshamextreme999/CNC-.git',
      live: 'https://cnc-pearl.vercel.app/#',
    ...
    },
    {
      ...
      github: 'https://github.com/Sakshamextreme999/MyPortfolio.git',
      live: 'https://my-portfolio-eight-zeta-30.vercel.app/',
      tech: 'HTML/CSS/JS',
      bgColor: 'bg-white/5'
    }
  ];
